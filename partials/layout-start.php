...
<div class="app-shell">
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <button class="nav-toggle" type="button" data-toggle="settings" aria-expanded="<?php echo $settingsOpen ? 'true' : 'false'; ?>">
            ...
            <button class="nav-toggle" type="button" data-toggle="admin" aria-expanded="<?php echo $adminOpen ? 'true' : 'false'; ?>">
